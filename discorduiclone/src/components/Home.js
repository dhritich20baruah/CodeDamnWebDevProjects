  ...
  return (
    <>
      ...
      <div className="footer bg-black pt-16">
        ...
        <div className="footer2 flex justify-end py-10">
        <div>
        <img src={Discordlogo} alt="logo"/>
        </div>
        <div>
        <button className='bg-[#5865f2] w-32 text-white py-2 my-4 rounded-3xl'>Sign up</button>
        </div>
        </div>
      </div>
